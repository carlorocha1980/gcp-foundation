resource "google_compute_disk" "gke_avantia_private_clus_default_pool_32a58553_vx67" {
  guest_os_features {
    type = "GVNIC"
  }
  ...
  name                      = "gke-avantia-private-clus-default-pool-32a58553-vx67"
...
# terraform import google_compute_disk.gke_avantia_private_clus_default_pool_32a58553_vx67 projects/dt-sandbox-service-proj/zones/us-central1-f/disks/gke-avantia-private-clus-default-pool-32a58553-vx67
