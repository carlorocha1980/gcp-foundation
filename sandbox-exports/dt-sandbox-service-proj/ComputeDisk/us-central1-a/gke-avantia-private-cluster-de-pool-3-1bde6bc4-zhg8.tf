resource "google_compute_disk" "gke_avantia_private_cluster_de_pool_3_1bde6bc4_zhg8" {
  guest_os_features {
    type = "GVNIC"
  }
  ...
  name                      = "gke-avantia-private-cluster-de-pool-3-1bde6bc4-zhg8"
...
# terraform import google_compute_disk.gke_avantia_private_cluster_de_pool_3_1bde6bc4_zhg8 projects/dt-sandbox-service-proj/zones/us-central1-a/disks/gke-avantia-private-cluster-de-pool-3-1bde6bc4-zhg8
