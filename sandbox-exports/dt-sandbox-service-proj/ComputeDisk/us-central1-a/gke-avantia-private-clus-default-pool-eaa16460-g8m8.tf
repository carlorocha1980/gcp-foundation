resource "google_compute_disk" "gke_avantia_private_clus_default_pool_eaa16460_g8m8" {
  guest_os_features {
    type = "GVNIC"
  }
  ...
  name                      = "gke-avantia-private-clus-default-pool-eaa16460-g8m8"
...
# terraform import google_compute_disk.gke_avantia_private_clus_default_pool_eaa16460_g8m8 projects/dt-sandbox-service-proj/zones/us-central1-a/disks/gke-avantia-private-clus-default-pool-eaa16460-g8m8
